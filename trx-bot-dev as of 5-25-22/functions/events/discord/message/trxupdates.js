...
if (context.params.event.content.startsWith(`${process.env.PREFIX}trxupdates`)) {
  ...
  embed: {
    ...
    description: `__**Log 5/18/22**__
    ~ __TRX Executors updates:__ TRX Executor & TRX Executor APEX updated to latest roblox version, optimized settings for APEX, fixed bugs
    ~ __TRX Ludicrous updates:__ *null*
    ~ __TRX Script/Script Hub updates:__ updated aimbot`,
    color: 16763904,
    footer: {
      text: `Powered by TRX`,
