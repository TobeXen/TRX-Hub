...
if (context.params.event.content.startsWith(`${process.env.PREFIX}WRD-apicheck`)) {
  ...
  embed: {
    type: `rich`,
    title: `🟢 WeAreDevs`,
    description: `__Current Version:__ ${process.env.vWRD}
    __Last Updated:__ 06/01/2022, 4:35 PM
